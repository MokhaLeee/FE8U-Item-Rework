...
static void DoEff_Heal(struct Unit*, u16 item);
static void DoEff_Physic(struct Unit*, u16 item);
static void DoEff_Restore(struct Unit*, u16 item);
static void DoEff_Rescue(struct Unit*, u16 item);
static void DoEff_Barrier(struct Unit*, u16 item);
static void DoEff_Silence(struct Unit*, u16 item);
static void DoEff_Sleep(struct Unit*, u16 item);
static void DoEff_Berserk(struct Unit*, u16 item);
static void DoEff_Warp(struct Unit*, u16 item);
static void DoEff_Repair(struct Unit*, u16 item);
static void DoEff_Unlock(struct Unit*, u16 item);
static void DoEff_Mine(struct Unit*, u16 item);
static void DoEff_LightRune(struct Unit*, u16 item);
static void DoEff_StaffTorch(struct Unit*, u16 item);
static void DoEff_DanceRing(struct Unit*, u16 item);


typedef void (*EffFunc_t)(struct Unit*, u16 item);

const EffFunc_t ItemMenuEffectTable[0xCE] = {
...
static void DoEff_Heal(struct Unit* unit, u16 item) {
...
static void DoEff_Physic(struct Unit* unit, u16 item) {
...
static void DoEff_Restore(struct Unit* unit, u16 item) {
...
static void DoEff_Rescue(struct Unit* unit, u16 item){
...
static void DoEff_Barrier(struct Unit* unit, u16 item){
...
static void DoEff_Silence(struct Unit* unit, u16 item){
...
static void DoEff_Sleep(struct Unit* unit, u16 item){
...
static void DoEff_Berserk(struct Unit* unit, u16 item){
...
static void DoEff_Warp(struct Unit* unit, u16 item){
...
static void DoEff_Repair(struct Unit* unit, u16 item){
...
static void DoEff_Unlock(struct Unit* unit, u16 item){
...
static void DoEff_Mine(struct Unit* unit, u16 item){
...
static void DoEff_LightRune(struct Unit* unit, u16 item){
...
static void DoEff_StaffTorch(struct Unit* unit, u16 item){
	Proc_Start(gProcScr_SquareSelectTorch, PROC_TREE_3);
	PlaySoundEffect(0x6A); // TODO: song ids
}

static void DoEff_DanceRing(struct Unit* unit, u16 item){
